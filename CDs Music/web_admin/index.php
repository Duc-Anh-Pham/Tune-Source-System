<?php
  ...
  if($_SESSION['managerID'] == null) {
		...
		echo 'window.location.href="login_manager/index.php"';
		echo '</script>';
  }
?>
<?php
        ...
        <div class="main-panel">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="../images/user/user1.jpg" class="me-2" alt="image">Pham Duc Anh
                            </td>
                            <td> Hello Team, Have a good day! </td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <img src="../images/user/user2.jpg" class="me-2" alt="image"> Pham Minh Anh
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="../images/user/user3.jpg" class="me-2" alt="image"> Pham Vy Anh
                            </td>
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex mt-5 align-items-top">
                      ...
                      <div class="mb-0 flex-grow">
                        <h5 class="me-2 mb-2">Business Website - Authentication Module.</h5>
                        <p class="mb-0 font-weight-light">It is a long established fact that readers will be more interested by the Readable Reviews and Votes of a website.</p>
                      </div>
                      <div class="ms-auto">
                    ...
                    <div class="list-wrapper">
                      <ul class="d-flex flex-column-reverse todo-list todo-list-custom">
                        ...
                        <li>
                          <div class="form-check">
                            <label class="form-check-label">
                              <input class="checkbox" type="checkbox"> Council meetings </label>
                          </div>
                          <i class="remove mdi mdi-close-circle-outline"></i>
                        </li>
                      </ul>
          ...
          <footer class="footer">
            <div class="container-fluid d-flex justify-content-between">
              <span class="text-muted d-block text-center text-sm-start d-sm-inline-block">Copyright © Tune Source Store <a href="../web/index.php" target="_blank">Welcome to Tune Source Store</a></span>
            </div>
          </footer>
          <!-- partial -->
        </div>
