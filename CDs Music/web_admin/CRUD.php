      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <p><a href="CRUD3.php" class="btn btn-outline-primary">Add Album</a></p>
          <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td><?= $row['albumID'] ?></td>
                    <td><?= $row['albumName'] ?></td>
                    <td><?= $row['albumPrice'] ?></td>  
                    <td>
                        <a href="#" title="<?= $row['albumDetails'] ?>">
                            <img src="../images\products\<?= $row['albumImage'] ?>" 
                    ...
                    <td>
                        <a href="CRUD1.php ?id=<?= $row['albumID'] ?>" title="Edit"><i class="fa-regular fa-pen-to-square"></i></a>
                        <a href="CRUD2.php ?id=<?= $row['albumID'] ?>" title="Delete" onclick="return confirm('Are You Sure ?');">
