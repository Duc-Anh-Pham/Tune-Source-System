...
<?php
    ...
    if(isset($_POST['addnew'])) {
        try {
			...
			$stmt->bindParam(3, $_POST['albumPrice']);
			$stmt->bindParam(4, $_POST['albumImage']);	
			$stmt->bindParam(5, $_POST['albumDetails']);
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/mysql/web_admin/index.php">
        ...
        <div class="main-panel">
          ...
          <div class="container mt-4">
            ...
            <button type="submit" class="btn btn-primary" name="addnew">Add new</a></button>
