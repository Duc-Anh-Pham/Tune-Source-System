                ...
                <div class="col-lg-6 col-6 text-left">
                 <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search for albums">
        ...
        <div class="row px-xl-5">
                ...
                <div class="border-bottom mb-4 pb-4">
                    ...
                    <form>
                        ...
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            ...
                            <label class="custom-control-label" for="price-1">55.000 VND - 70.000 VND </label>
                            <span class="badge border font-weight-normal">4</span>
                        </div>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" id="price-2">
                            <label class="custom-control-label" for="price-2">75.000 VND - 85.000 VND</label>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                    ...
                    <?php if($sothutu >= 6 && $sothutu <= 8) { ?>

                        <div class="col-lg-4 col-md-6 col-sm-12 pb-1" >
                            <div class="card album-item border-0 mb-4">
                                <div class="card-header album-img position-relative overflow-hidden bg-transparent border p-0">
                                    <img class="img-fluid w-100" src="../images\products\<?= $row['albumImage'] ?>" alt="">
                                </div>  
                                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                    <h6 class="text-truncate mb-3"><?= $row['albumName'] ?></h6>
                                    <div class="d-flex justify-content-center">
                                        <h6><?= $row['albumPrice'] ?></h6><h6 class="text-muted ml-2"><del> 400</del></h6>
                                    </div>
                                </div>
                    ...
                    <div class="col-12 pb-1">
                        <nav aria-label="Page navigation">
                          <ul class="pagination justify-content-center mb-3">   
                            ...
                            <li class="page-item active"><a class="page-link" href="shop2.php">2</a></li>
                            <li class="page-item"><a class="page-link" href="shop3.php">3</a></li>
                            <li class="page-item">
                              <a class="page-link" href="shop3.php" aria-label="Next">
