                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-50 m-0">
    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-50 h-50" src="../images/products/product01.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-50 h-50" src="../images/products/product05.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-50 h-50" src="../images/products/product04.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-50 h-50" src="../images/products/product11.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-50 h-50" src="../images/products/product12.jpg" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold">Combo types of CDs are hot</h3>
                <div class="d-flex mb-3">
                    ...
                    <small class="pt-1">(5000 Reviews)</small>
                </div>
                <h3 class="font-weight-semi-bold mb-4">500</h3>
                <p class="mb-4">- "CDs - High-quality audio storage system, helping you to convey musical emotions to every corner of the world.".</p>
        ...
        <div class="row px-xl-5">
            <div class="col">
                <div class="nav nav-tabs justify-content-center border-secondary mb-4">
                    ...
                    <a class="nav-item nav-link" data-toggle="tab" href="#tab-pane-3">Reviews (4000)</a>
                </div>
                    ...
                    <div class="tab-pane fade show active" id="tab-pane-1">
                        ...
                        <div class="col-md-6">
                            <ul class="list-group list-group-flush">
                                ...
                                Music storage and playback: CDs are used to store and play high-quality music, providing a great audio experience for listeners.
                                </li>
                                <li class="list-group-item px-0">
                                Data storage: CDs can store various data such as photos, videos, office documents, software programs... and are used in data backup.
                                </li>
                              </ul> 
                        </div>
                        ...
                        <div class="col-md-6">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item px-0">
                                "Easy to store and carry: CDs are compact in size and easy to store, carry and use on many different devices such as computers, laptops, CD players...</li>
                                <li class="list-group-item px-0">
                                Data protection: CDs are more resistant to scratches and interference than other storage media such as hard disks or USBs."
                                </li>
                                <li class="list-group-item px-0">
                                High reliability: CDs have a long lifespan and high reliability, helping to protect data securely and reliably.</li>
                                <li class="list-group-item px-0">
                                Independent of the internet: CDs do not need an internet connection to use and can work anywhere, ensuring flexibility and convenience
                                </li>
                              </ul> 
                        </div>
                ...
                <div class="owl-carousel related-carousel">
                    <div class="card product-item border-0">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            <img class="img-fluid w-100" src="../images/products/product01.jpg" alt="">
                        </div>
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3">Iphone 12 Pro Max case</h6>
                            <div class="d-flex justify-content-center">
                                <h6>80</h6><h6 class="text-muted ml-2"><del>123</del></h6>
                            </div>
                        </div>
                    ...
                    <div class="card product-item border-0">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            <img class="img-fluid w-100" src="../images/products/product02.jpg" alt="">
                        </div>
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3">	Iphone 11 Pro Max case</h6>
                            <div class="d-flex justify-content-center">
                                <h6>82</h6><h6 class="text-muted ml-2"><del>123</del></h6>
                            </div>
                        </div>
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                    ...
                    <div class="card product-item border-0">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            <img class="img-fluid w-100" src="../images/products/product03.jpg" alt="">
                        </div>
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3">	HTC U12 Plus Case</h6>
                            <div class="d-flex justify-content-center">
                                <h6>70</h6><h6 class="text-muted ml-2"><del>123</del></h6>
                            </div>
                        </div>
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                    ...
                    <div class="card product-item border-0">
                        ...
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3">HTC Desire 826 Case</h6>
                            <div class="d-flex justify-content-center">
                                <h6>75</h6><h6 class="text-muted ml-2"><del>123</del></h6>
                            </div>
                        </div>
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                    ...
                    <div class="card product-item border-0">
                        ...
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3">	Samsung Galaxy S22</h6>
                            <div class="d-flex justify-content-center">
                                <h6>78</h6><h6 class="text-muted ml-2"><del>123</del></h6>
                            </div>
                        </div>
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
