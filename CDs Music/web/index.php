        ...
        <div class="row border-top px-xl-5">
            ...
            <div class="col-lg-9">
                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <a class="carousel-control-prev-auto" href="#header-carousel" data-slide="prev">
                        <!-- <div class="btn btn-dark" style="width: 45px; height: 45px;">
                            <span class="carousel-control-prev-icon mb-n2"></span>
                        </div> -->
                    </a>
                    <a class="carousel-control-next-auto" href="#header-carousel" data-slide="next">
                        <!-- <div class="btn btn-dark" style="width: 45px; height: 45px;">
        ...
        <div class="row px-xl-5 pb-3">
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right"> 1 Product</p>
                    <a href="../web/pop.php" class="cat-img position-relative-centre overflow-hidden mb-3">
                        <img class="img-fluid" src="../images/products/product02.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Appetite for Destruction</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">1 Products</p>
                    <a href="../web/rock.php" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="../images/products/product05.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Discovery</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">1 Products</p>
                    <a href="../web/hip-hop.php" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="../images/products/product04.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">A Love Supreme</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    ...
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="../images/products/product07.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Texas Flood</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">1 Products</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="../images/products/product08.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Songs in the Key of Life</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">1 Products</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="../images/products/product09.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Red Headed Stranger</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid offer pt-5">
        <div class="row px-xl-6">
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-right text-white mb-2 py-3 px-3">
                    <img src="../images/products/product10.jpg" height="200px" alt="">
                    <div class="position-relative" style="z-index: 1;">
                        <h5 class="text-uppercase text-primary mb-3">20% off the all order</h5>
                        <h1 class="mb-4 font-weight-semi-bold">Buena Vista Social Club</h1>
                        <a href="" class="btn btn-outline-primary py-md-2 px-md-3">Shop Now</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-left text-white mb-2 py-3 px-3">
                    <img src="../images/products/product01.jpg" height="200px" alt="">
                    <div class="position-relative" style="z-index: 1;">
                        <h5 class="text-uppercase text-primary mb-3">20% off the all order</h5>
                        <h1 class="mb-4 font-weight-semi-bold">Lover</h1>
                        <a href="" class="btn btn-outline-primary py-md-2 px-md-3">Shop Now</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row px-xl-5 pb-3">
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header pro duct-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="../images/products/product05.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Discovery</h6>
                        <div class="d-flex justify-content-center">
                            <h6>52</h6><h6 class="text-muted ml-2"><del>330</del></h6>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="../images/products/product04.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">	A Love Supreme</h6>
                        <div class="d-flex justify-content-center">
                            <h6>75</h6><h6 class="text-muted ml-2"><del>230</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="../images/products/product06.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">The Four Seasons</h6>
                        <div class="d-flex justify-content-center">
                            <h6>85</h6><h6 class="text-muted ml-2"><del>123</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="../images/products/product07.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Texas Flood</h6>
                        <div class="d-flex justify-content-center">
                        <h6>65</h6><h6 class="text-muted ml-2"><del>330</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
        ...
        <div class="row justify-content-md-center py-5 px-xl-5">
            <div class="col-md-6 col-12 py-5">
                <div class="text-center mb-2 pb-2">
                    <h1 class="section-title px-5 mb-3"><span class="bg-secondary px-2">Stay Updated</span></h1>
                    <h3>New products will always be updated and youthful designs catch up with trends.</h3>
                    <p><br>Please leave your email so that when a new product comes out you will be the first to know to buy and own it.</br></p>
                </div>
                <form action="">
                    <div class="input-group">
                        <input type="text" class="form-control border-white p-4" placeholder="Please book in advance by Email">
                        <div class="input-group-append">
