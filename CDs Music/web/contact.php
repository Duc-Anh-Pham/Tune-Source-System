    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-5 mb-5">
                ...
                <p>Please contact and visit. We are pleased to welcome you!</p>
                <div class="d-flex flex-column mb-3">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>(+84) 903796863  (+84) 943206863</p>
                </div>
                <div class="d-flex flex-column">
                    <h5 class="font-weight-semi-bold mb-3">Store 2</h5>
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Chau Son Ward, Phu Ly City, Ha Nam Province</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>ducanh04022003@gmail.com</p>
