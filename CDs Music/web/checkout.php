                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="text" placeholder="Enter your Zip Code">
                        </div>
                        ...
                        <div class="col-md-12 form-group">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="shipto"  data-toggle="collapse" data-target="#shipping-address">Use as default address</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        ...
                        <!-- <div class="d-flex justify-content-between">
                            <p> Iphone 12 Pro Max case</p>
                            <p>80.000 VND</p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p> Samsung Galaxy S22 Ultra Case</p>
                            <p>78.000 VND</p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p>Motorola G6 Plus Case</p>
                            <p>65.000 VND</p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p>Iphone 13 Pro Max Case</p>
                            <p>88.000 VND</p>
                        </div> -->
                        <div class="d-flex justify-content-between">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <h5 class="font-weight-bold">410.000 VND</h5>
                        </div>
                    </div>
                </div>
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        ...
                        <script>
                           document.getElementById("place-order-button").addEventListener("click", function() {
                             // Xử lý đặt hàng (kiểm tra thông tin, gửi đến API, etc.)

                             // Sau khi đặt hàng thành công, hiển thị thông báo
